...
if self.vardict_boo['cvar1'].get() == 1:
    ...
    Call('dcv', 10,'-2 V','r1','s1', 0.05)
    Call('dcv', 10, '-9.9 V','t1','u1', 0.05)
    # dc 2.5V
    Callpar(20, '0100')
    Call('dcv', 2.5, '2.5 V','b17','c17', 0.05)
    Call('dcv', 2.5, '0.5 V','d17','e17', 0.05)
    Call('dcv', 2.5, '0.1 V','f17','g17', 0.05)
    Call('dcv', 2.5, '0.02 V','h17','i17', 0.05)
    Call('dcv', 2.5, '0.005 V','j17','k17', 0.05)
    Call('dcv', 2.5, '-0.005 V','l17','m17', 0.05)
    Call('dcv', 2.5, '-0.02 V','n17','o17', 0.05)
    Call('dcv', 2.5, '-0.1 V','p17','q17', 0.05)
    Call('dcv', 2.5, '-0.5 V','r17','s17', 0.05)
    Call('dcv', 2.5, '-2.5 V','t17','u17', 0.05)
    # dc 0.625V
    Callpar(20, '1000')
    Call('dcv', 0.625, '0.6 V','b33','c33', 0.1)
    Call('dcv', 0.625, '0.2 V','d33','e33', 0.1)
    Call('dcv', 0.625, '0.05 V','f33','g33', 0.1)
    Call('dcv', 0.625, '0.01 V','h33','i33', 0.1)
    Call('dcv', 0.625, '0.002 V','j33','k33', 0.1)
    Call('dcv', 0.625, '-0.002 V','l33','m33', 0.1)
    Call('dcv', 0.625, '-0.01 V','n33','o33', 0.1)
    Call('dcv', 0.625, '-0.05 V','p33','q33', 0.1)
    Call('dcv', 0.625, '-0.2 V','r33','s33', 0.1)
    Call('dcv', 0.625, '-0.6 V','t33','u33', 0.1)
    # dc 0.1562V
    Callpar(20, '1100')
    Call('dcv', 0.1562, '0.15 V','b49','c49', 0.5)
    Call('dcv', 0.1562, '0.08 V','d49','e49', 0.5)
    Call('dcv', 0.1562, '0.02 V','f49','g49', 0.5)
    Call('dcv', 0.1562, '0.005 V','h49','i49', 0.5)
    Call('dcv', 0.1562, '0.001 V','j49','k49', 0.5)
    Call('dcv', 0.1562, '-0.001 V','l49','m49', 0.5)
    Call('dcv', 0.1562, '-0.005 V','n49','o49', 0.5)
    Call('dcv', 0.1562, '-0.02 V','p49','q49', 0.5)
    Call('dcv', 0.1562, '-0.08 V','r49','s49', 0.5)
    Call('dcv', 0.1562, '-0.15 V','t49','u49', 0.5)
# ac0
if self.vardict_boo['cvar3'].get() == 1:
    ...
    # 20kHz 0.1562B
    Callpar(20, '1100')
    Call('ac0', 0.1562, '0.001 V, 0.1 kHz', 'n77', 'o77', 0.5)
    Call('ac0', 0.1562, '0.001 V, 9.0 kHz', 'n78', 'o78', 0.5)
    ...
    # 100kHz 0.1562B
    Callpar(100, '1100')
    Call('ac0', 0.1562, '0.001 V, 1.0 kHz', 'n79', 'o79', 10)
    Call('ac0', 0.1562, '0.001 V, 49.0 kHz', 'n80', 'o80', 10)
    ...
    # 200kHz 0.1562B
    Callpar(200, '1100')
    Call('ac0', 0.1562, '0.001 V, 1.0 kHz', 'n81', 'o81', 100)
    Call('ac0', 0.1562, '0.001 V, 99.0 kHz', 'n82', 'o82', 100)
    ...
    # 400kHz 0.1562B
    Callpar(400, '1100')
    Call('ac0', 0.156, '0.001 V, 1.0 kHz', 'n83', 'o83', 100)
    Call('ac0', 0.1562, '0.001 V, 199.0 kHz', 'n84', 'o84', 100)
...
if self.vardict_boo['cvar4'].get() == 1:
    ...
    # 20kHz 0.1562B
    Callpar(20, '1100')
    Call('acv', 0.1562, '0.001 V, 0.02 kHz', 'n117', 'o117', 0.5)
    Call('acv', 0.1562, '0.001 V, 0.501 kHz', 'n133', 'o133', 0.5)
    ...
    # 100kHz 0.1562B
    Callpar(100, '1100')
    Call('acv', 0.1562, '0.001 V, 0.02 kHz', 'n181', 'o181', 10)
    Call('acv', 0.1562, '0.001 V, 3.0 kHz', 'n197', 'o197', 10)
    ...
    # 200kHz 0.1562B
    Callpar(200, '1100')
    Call('acv', 0.1562, '0.001 V, 0.02 kHz', 'n245', 'o245', 100)
    Call('acv', 0.1562, '0.001 V, 6.0 kHz', 'n261', 'o261', 100)
    ...
    # 400kHz 0.1562B
    Callpar(400, '1100')
    Call('acv', 0.1562, '0.001 V, 0.02 kHz', 'n309', 'o309', 100)
    Call('acv', 0.1562, '0.001 V, 12.0 kHz', 'n325', 'o325', 100)
...
if self.dac == 1:
    ...
    if self.vardict_boo['cvar5'].get() == 1:
        ...
        Ldac('0 DC', 2000, 'd341', 'e341', 0.3)
        Ldac('0 DC', 1000, 'f341', 'g341', 0.3)
        Ldac('0 DC', 250, 'h341', 'i341', 0.3)
        Ldac('0 DC', 3, 'j341', 'k341', 0.3)
        Ldac('0 DC', -3, 'l341', 'm341', 0.3)
        Ldac('0 DC', -250, 'n341', 'o341', 0.3)
        Ldac('0 DC', -1000, 'p341', 'q341', 0.3)
        Ldac('0 DC', -2000, 'r341', 's341', 0.3)
        Ldac('0 DC', -4750, 't341', 'u341', 0.3)
    # DAC2
    if self.vardict_boo['cvar6'].get() == 1:
        Message('Подключите выход ЦАП2 к мультиметру')
        Callpar(20, '0000')
        Ldac('1 DC', 4750, 'b342', 'c342', 0.3)
        Ldac('1 DC', 2000, 'd342', 'e342', 0.3)
        Ldac('1 DC', 1000, 'f342', 'g342', 0.3)
        Ldac('1 DC', 250, 'h342', 'i342', 0.3)
        Ldac('1 DC', 3, 'j342', 'k342', 0.3)
        Ldac('1 DC', -3, 'l342', 'm342', 0.3)
        Ldac('1 DC', -250, 'n342', 'o342', 0.3)
        Ldac('1 DC', -1000, 'p342', 'q342', 0.3)
        Ldac('1 DC', -2000, 'r342', 's342', 0.3)
        Ldac('1 DC', -4750, 't342', 'u342', 0.3)
Reset()
